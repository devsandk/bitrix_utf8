...
Class bitrix_eshop extends CModule
{
	...
	function InstallDB($install_wizard = true)
	{
		...
		RegisterModuleDependences("sale", "OnBasketAdd", "bitrix.eshop", "CEShop", "OnBasketChange");
		RegisterModuleDependences("sale", "OnBasketDelete", "bitrix.eshop", "CEShop", "OnBasketChange");
	...
	function UnInstallDB($arParams = Array())
	{
		...
		UnRegisterModuleDependences("sale", "OnBasketAdd", "bitrix.eshop", "CEShop", "OnBasketChange");
		UnRegisterModuleDependences("sale", "OnBasketDelete", "bitrix.eshop", "CEShop", "OnBasketChange");
