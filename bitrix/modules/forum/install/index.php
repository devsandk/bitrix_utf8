...
Class forum extends CModule
{
	...
	{
		$errors = null;
		$id = (in_array($id, array("all", "disk")) ? $id : false);
		if (!!$id && IsModuleInstalled("disk"))
		{
			$arFields = array(
			...
			$rsData = CUserTypeEntity::GetList(array("ID" => "ASC"), array("ENTITY_ID" => "FORUM_MESSAGE", "FIELD_NAME" => "UF_FORUM_MESSAGE_DOC"));
