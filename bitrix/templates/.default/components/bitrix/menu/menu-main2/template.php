...
<?if (!empty($arResult)) {?>
	<ul class="sf-menu">
		...
		<li class="sub-menu<?if ($arItem["SELECTED"]) echo' current';?>"><a href="<?=$arItem["LINK"]?>"><font color="#015077"><b><?=$arItem["TEXT"]?></b></font></a>
						<ul>
				<?} else {?>
			...
			<?} else {?>
				<?if ($arItem["PERMISSION"] > "D") {?>
					<?if ($arItem["DEPTH_LEVEL"] == 1) {?>
						<li<?if ($arItem["SELECTED"]) echo' class="current"';?>><a href="<?=$arItem["LINK"]?>"><font color="#015077"><b><?=$arItem["TEXT"]?></b></font></a></li>
					<?} else {?>
						<li<?if ($arItem["SELECTED"]) echo' class="current"';?>><a href="<?=$arItem["LINK"]?>"><font color="#015077"><b><?=$arItem["TEXT"]?></b></font></a></li>
					<?}?>
				<?} else {?>
