<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?>
								<?$APPLICATION->IncludeComponent("bitrix:main.include", "", Array(
									...
									"AREA_FILE_SUFFIX" => "bottom_2",	// РЎСѓС„С„РёРєСЃ РёРјРµРЅРё С„Р°Р№Р»Р° РІРєР»СЋС‡Р°РµРјРѕР№ РѕР±Р»Р°СЃС‚Рё
									"AREA_FILE_RECURSIVE" => "Y",	// Р РµРєСѓСЂСЃРёРІРЅРѕРµ РїРѕРґРєР»СЋС‡РµРЅРёРµ РІРєР»СЋС‡Р°РµРјС‹С… РѕР±Р»Р°СЃС‚РµР№ СЂР°Р·РґРµР»РѕРІ
									"EDIT_MODE" => "html",
									"EDIT_TEMPLATE" => "sect_bottom_2.php",	// РЁР°Р±Р»РѕРЅ РѕР±Р»Р°СЃС‚Рё РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ
									),
									false
								);?>
		   	 				</div>
							...
							"AREA_FILE_SHOW" => "sect",	// РџРѕРєР°Р·С‹РІР°С‚СЊ РІРєР»СЋС‡Р°РµРјСѓСЋ РѕР±Р»Р°СЃС‚СЊ
							"AREA_FILE_SUFFIX" => "right_2",	// РЎСѓС„С„РёРєСЃ РёРјРµРЅРё С„Р°Р№Р»Р° РІРєР»СЋС‡Р°РµРјРѕР№ РѕР±Р»Р°СЃС‚Рё
							"AREA_FILE_RECURSIVE" => "Y",	// Р РµРєСѓСЂСЃРёРІРЅРѕРµ РїРѕРґРєР»СЋС‡РµРЅРёРµ РІРєР»СЋС‡Р°РµРјС‹С… РѕР±Р»Р°СЃС‚РµР№ СЂР°Р·РґРµР»РѕРІ
							"EDIT_MODE" => "html",
							"EDIT_TEMPLATE" => "sect_right_2.php",	// РЁР°Р±Р»РѕРЅ РѕР±Р»Р°СЃС‚Рё РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ
							),
							false
						);?>
		  			</div>
